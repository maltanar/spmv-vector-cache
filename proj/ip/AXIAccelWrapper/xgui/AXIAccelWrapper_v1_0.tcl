...
proc init_gui { IPINST } {
  ...
  set NUM_MEM_PORTS [ipgui::add_param $IPINST -name "NUM_MEM_PORTS" -parent ${Page_0} -widget comboBox]
  set_property tooltip {Number of memory access ports} ${NUM_MEM_PORTS}

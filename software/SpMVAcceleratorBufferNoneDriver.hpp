...
public:
 static unsigned int expSignature() {return 0xcc31661e;};
 ...
 // read+write register: debug index: 10
 void debug(unsigned int v) {m_baseAddr[10] = v;};
 unsigned int debug() {return m_baseAddr[10];};

...
public:
 static unsigned int expSignature() {return 0x77adcc3f;};
 ...
 // read+write register: capacityStalls index: 14
 void capacityStalls(unsigned int v) {m_baseAddr[14] = v;};
 unsigned int capacityStalls() {return m_baseAddr[14];};

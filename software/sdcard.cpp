...
/* This needs support from the Xilinx-provided BSP (board support package) to work.
 *  - enable xilffs in the BSP settings
 *  - in <BSP sources>/libsrc/xilffs_vxx/src/include/ffconf.h and <BSP sources>/include/ffconf.h, set:
 *    - _FS_MINIMIZE to 0
 *    - _USE_LFN to 1
 */
